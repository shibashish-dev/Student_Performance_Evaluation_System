...
import PersonalDetails from '@/app/components/teachers/PersonalDetails';
import UserProfile from '@/app/components/teachers/UserProfile';
...
const Dashboard = () => {
  ...
  return (
    <>
        <Banner href={'/teacher/dashboard'} text={'Teacher Dashboard'} title={'Dashboard'}/>
